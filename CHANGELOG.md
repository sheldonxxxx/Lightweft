...
- Add a shared local photo review application with extensible edit, style, and detail review panels, persisted session feedback, and agent-readable review data.
- Add a workspace-oriented photo-style-builder skill for collaborative look exploration, qualitative edit profiles, and validated editor preset provenance.
- Separate personal style development from the master skill's image-specific editing foundation, and route ongoing review work through the shared application.
- Keep review dropdowns and their options in the dark theme, improve secondary text and focus visibility, and fit review controls and dialogs on narrow screens.
